...
```{r}
# create the data 
data<- rbind(matrix(rep('Triangle',165),165,1,byrow=TRUE),matrix(rep('No_triangle',70),70,1,byrow=TRUE))
#add region categories 
data <- cbind.data.frame(data,c(rep('Cary',115),rep('Raleigh',10),rep('Durham',40),rep('Ashville',30),rep('Carolina beach',40)),100*runif(235))
